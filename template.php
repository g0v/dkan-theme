 ...
 */
function dg0v_preprocess_page(&$vars) {
 ...
 */
function dg0v_breadcrumb($variables) {
  if (drupal_is_front_page()) {
    return;
  }
 ...
 */
function dg0v_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function dg0v_menu_local_task($variables) {
 ...
 * @ingroup themeable
 */
function dg0v_facetapi_link_inactive($variables) {
 ...
 * @ingroup themeable
 */
function dg0v_facetapi_link_active($variables) {
  // Sanitizes the link text if necessary.
  $sanitize = empty($variables['options']['html']);
 ...
 * Theme social icons.
 */
function dg0v_sitewide_social_block() {
 ...
 */
function dg0v_form_alter(&$form, &$form_state, $form_id) {
  switch ($form_id) {
 ...
 */
function dg0v_file_widget($variables) {
