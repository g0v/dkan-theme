 ...
 */
function dg0v_form_system_theme_settings_alter(&$form, &$form_state) {
  // Hero fieldset.
  $form['hero'] = array(
    '#type' => 'fieldset',
    '#title' => t('Hero Unit'),
  ...
  $form['#submit'][] = 'dg0v_settings_submit';
}

/**
 * Implements hook_setings_submit().
 */
function dg0v_settings_submit($form, &$form_state) {
  $settings = array();
  ...
  if ($previous !== path_to_theme().'/images/hero.jpg') {
